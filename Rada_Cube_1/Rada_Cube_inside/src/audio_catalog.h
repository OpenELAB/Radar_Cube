...
#define AUDIO_PATH_SHUTDOWN              "/sys_shutdown.wav"
...
#define AUDIO_PATH_CONNECTION_LOST       "/fault_comm.wav"
#define AUDIO_PATH_LOW_BATTERY           "/power_low.wav"
#define AUDIO_PATH_FAULT                 "/fault_system.wav"
